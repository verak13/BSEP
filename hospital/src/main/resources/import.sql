...
insert into patients (id, jmbg, first_name, last_name, birth_date, height, weight, gender, blood_type) VALUES (1, 'q6yxgJQ/7gs79aQyFB7saQ==', 'tzWUbzeJ6ehmv9VauNu04A==', '9VsnQUjFH/aY/lz9KuZ2iw==', '1998-06-10 12:00:00', 180.1, 81.6, 'MALE', 'B');
insert into patients (id, jmbg, first_name, last_name, birth_date, height, weight, gender, blood_type) VALUES (2, '1q6yxgJQ/7gs79aQyFB7saQ==', 'tzWUbzeJ6ehmv9VauNu04A==', '9VsnQUjFH/aY/lz9KuZ2iw==', '1982-05-13 12:00:00', 170.0, 58.0, 'FEMALE', 'A');
insert into patients (id, jmbg, first_name, last_name, birth_date, height, weight, gender, blood_type) VALUES (3, '2q6yxgJQ/7gs79aQyFB7saQ==', 'tzWUbzeJ6ehmv9VauNu04A==', '9VsnQUjFH/aY/lz9KuZ2iw==', '1959-02-05 12:00:00', 169.3, 75.2, 'MALE', 'AB');
insert into patients (id, jmbg, first_name, last_name, birth_date, height, weight, gender, blood_type) VALUES (4, '3q6yxgJQ/7gs79aQyFB7saQ==', 'tzWUbzeJ6ehmv9VauNu04A==', '9VsnQUjFH/aY/lz9KuZ2iw==', '1994-11-21 12:00:00', 180.0, 76.0, 'MALE', '0');
insert into patients (id, jmbg, first_name, last_name, birth_date, height, weight, gender, blood_type) VALUES (5, '4q6yxgJQ/7gs79aQyFB7saQ==', 'tzWUbzeJ6ehmv9VauNu04A==', '9VsnQUjFH/aY/lz9KuZ2iw==', '2005-11-01 12:00:00', 162.5, 53.0, 'FEMALE', 'A');
...
insert into messages(patient_id, blood_pressure_diastolic, blood_pressure_systolic, body_temperature, pulse_raye, respiration_rate, timestamp) values (4, 119.0, 87.0, 36.2, 79.0, 16.0, '2021-06-10 12:00:00');
insert into messages(patient_id, blood_pressure_diastolic, blood_pressure_systolic, body_temperature, pulse_raye, respiration_rate, timestamp) values (5, 121.0, 91.0, 36.6, 91.0, 14.0, '2021-06-10 12:00:00');
...
insert into message_alarms(date, patient_id, variable, value, other_value) values ('2021-06-10 13:08:00', 3, 'Custom Rule Alarm!', null, null);
