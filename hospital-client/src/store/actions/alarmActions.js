import { GET_ALARMS_BLACKLISTED, SET_ALARMS_BLACKLISTED, GET_ALARMS_BRUTEFORCE, SET_ALARMS_BRUTEFORCE, 
    GET_ALARMS_ERROR, SET_ALARMS_ERROR, GET_ALARMS_INACTIVE, SET_ALARMS_INACTIVE,
    GET_ALARMS_CUSTOM, SET_ALARMS_CUSTOM } from './actionTypes';
...
export const getAlarmsCustom = payload => ({
    type: GET_ALARMS_CUSTOM,
    payload
})

export const setAlarmsCustom = payload => ({
    type: SET_ALARMS_CUSTOM,
    payload
})